...
public class Task {
    ...
    public Task(UUID id, String title, LocalDateTime updated, LocalDateTime created, TaskPriority priority, TaskStatus status, LocalDateTime dueDate, String description) {
        this.id = id;
        this.title = title;
