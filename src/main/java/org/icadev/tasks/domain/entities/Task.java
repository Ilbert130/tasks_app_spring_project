...
public class Task {
    ...
    public Task(UUID id, String title, String description, LocalDateTime dueDate, TaskStatus status, TaskPriority priority, LocalDateTime created, TaskList taskList, LocalDateTime updated) {
        this.id = id;
        this.title = title;
